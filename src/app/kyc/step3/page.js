...
const KYCStep3Page = () => {
  ...
  const handleNext = () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      localStorage.setItem('kyc_step3', JSON.stringify(formData));
          ...
          <div className="bg-black/80 backdrop-blur-lg rounded-2xl border border-white/10 p-8">
            <div className="mb-8">
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold">Identity Document Details</h1>
                  <p className="text-gray-400">Determines what document will be uploaded and enables doc-specific validation.</p>
                </div>
              </div>
