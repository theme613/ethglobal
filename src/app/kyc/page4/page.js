...
import { ArrowRight, ArrowLeft, Camera, CheckCircle, FileText } from "lucide-react";
...
const KYCPage4 = () => {
  ...
  const handleNext = () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      localStorage.setItem('kyc_page4', JSON.stringify(formData));
      router.push("/kyc/page5");
    }
  };
            ...
            <div className="mb-8">
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Required for doc verification (OCR, fraud checks) and face match.</p>
                </div>
              </div>
