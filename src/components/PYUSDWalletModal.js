...
const PYUSDWalletModal = ({ isOpen, onClose }) => {
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-red-100 text-red-700 py-2 px-4 rounded-lg font-medium hover:bg-red-200 flex items-center justify-center space-x-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default PYUSDWalletModal;
